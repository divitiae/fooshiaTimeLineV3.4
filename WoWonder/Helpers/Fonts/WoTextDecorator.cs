...
namespace WoWonder.Helpers.Fonts
{
    public class WoTextDecorator
    {
        ...
        //        {
        //            textPlaying = "  " + IonIconsFonts.IosGameControllerB + " " + mainContext.GetText(Resource.String.Lbl_IsPlaying) + " " + item.PostPlaying;
        ...
        //        {
        //            textLocation = "  " + IonIconsFonts.Location + " " + item.PostMap.Replace("/", "");
        ...
        //        if (publisher.Verified == "1")
        //            SetTextColor(IonIconsFonts.CheckmarkCircled, "#55acee");
        ...
        //            SetTextColor(IonIconsFonts.IosGameControllerB, "#FF9800");
        //            SetRelativeSize(IonIconsFonts.IosGameControllerB, 1.3f);
        //        }
        ...
        //            SetTextColor(IonIconsFonts.Location, "#E91E63");
        //            SetRelativeSize(IonIconsFonts.Location, 1.3f);
        //        }
        ...
        public SpannableString SetupStrings(PostDataObject item, Context mainContext)
        {
            try
            {
                ...
                if (item.ParentId != "0")
                {
                    ...
                    {
                        textShare += " " + "[img src=post_icon_arrow_forward/]" + " " + Methods.FunString.DecodeString(WoWonderTools.GetNameFinal(item.Recipient.RecipientClass)); //IonIconsFonts.ArrowRightC
                        textHighLighter += textShare;
                    }
                    else
                    {
