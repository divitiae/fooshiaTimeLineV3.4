...
namespace WoWonder.Helpers.Utils
{
    ...
    public static partial class Methods
    {
        ...
        public static class MultiMedia
        {
            ...
            public static Bitmap Retrieve_VideoFrame_AsBitmap(Context context, [NotNull] string mediaFile, ThumbnailKind thumbnailKind = ThumbnailKind.MiniKind)
            {
                ...
                try
                {
                    ...
                    activity.RunOnUiThread(() =>
                    {
                        try
                        {
                            ...
                            dialog.PositiveText(activity.GetText(Resource.String.Lbl_Close)).OnPositive((materialDialog, action) =>
                            {
                                try
                                {
                                    action.Dispose();
        ...
        public static class App
        {
            ...
            {
                int id = context.Resources.GetIdentifier("status_bar_height", "dimen", "android");
                return id > 0 ? context.Resources.GetDimensionPixelSize(id) : id;
            }
        ...
        public static class AttachmentFiles
        {
            ...
            private static string GetExternalFilePath(Context context, string fileName)
            {
                var filePath = context.GetExternalFilesDir(null).AbsolutePath;
                filePath = filePath.Substring(0, filePath.IndexOf("Android", StringComparison.OrdinalIgnoreCase));
