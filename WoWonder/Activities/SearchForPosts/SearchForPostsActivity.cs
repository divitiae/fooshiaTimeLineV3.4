    ...
    public class SearchForPostsActivity : BaseActivity, TextView.IOnEditorActionListener
    {
        ...
        private void SetRecyclerViewAdapters()
        {
            try
            {
                ...
                PostFeedAdapter = new NativePostAdapter(this, IdSearch, MainRecyclerView, NativeFeedType.SearchForPosts, SupportFragmentManager);
        ...
        private void StartApiService(string offset = "0")
        {
            if (!Methods.CheckConnectivity())
                ...
                PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => MainRecyclerView.FetchSearchForPosts(offset, IdSearch, SearchText, TypeSearch) });
        }
