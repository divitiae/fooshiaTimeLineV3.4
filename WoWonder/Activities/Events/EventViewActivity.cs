...
namespace WoWonder.Activities.Events
{
    ...
    public class EventViewActivity : BaseActivity, IOnMapReadyCallback, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, IOnOffsetChangedListener
    {
