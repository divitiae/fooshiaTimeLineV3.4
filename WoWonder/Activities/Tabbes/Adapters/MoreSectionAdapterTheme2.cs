...
{ 
    public class MoreSectionAdapterTheme2 : RecyclerView.Adapter
    {
        public ObservableCollection<SectionItem> SectionList = new ObservableCollection<SectionItem>();
        private readonly Activity ActivityContext;
        public MoreSectionAdapterTheme2(Activity activityContext)
        {
            try
            {
                HasStableIds = true;
                ...
                if (AppSettings.ShowGames)
                    SectionList.Add(new SectionItem
                    {
                        ...
                        Icon = IonIconsFonts.IosGameControllerB,
                        IconColor = Color.ParseColor("#03A9F4")
                    });
                //Settings Page
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
        {
            try
            {
                ...
                if (viewHolder is MoreSectionAdapterViewHolderTheme2 holder)
                {
                ...
                {
                    if (viewHolder is MoreSectionAdapterViewHolder holder2)
                    {
                        if (AppSettings.FlowDirectionRightToLeft)
                        {
        ...
        public override int GetItemViewType(int position)
        {
            try
            {
                if (SectionList[position].StyleRow == 0)
                    return 1;
                else
                    return 2;
            }
