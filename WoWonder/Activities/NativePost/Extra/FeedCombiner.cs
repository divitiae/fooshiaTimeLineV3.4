            ...
            try
            {
                if (isSharing)
                {
                    ...
                    var item = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)getSharedPostType + collection.Id),
                        PostData = collection,
                ...
                else
                {
                    ...
                    var item = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostFeedType + PostCollection.Id),
                ...
                else
                {
                    ...
                    if (isPromoted)
                    {
                        var item = new AdapterModelsClass
                        {
                            ...
                            Id = Convert.ToInt32((int)PostModelType.PromotePost + PostCollection.Id),
                            PostData = PostCollection,
                            IsDefaultFeedPost = true,
                        };
                        PostList.Add(item);
            ...
            try
            {
                if (isSharing)
                {
                    ...
                    var item = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostModelType.SharedHeaderPost + collection.Id),
                        PostData = collection,
                        IsDefaultFeedPost = true,
                    };
                    PostList.Add(item);
                ...
                else
                {
                    ...
                    var item = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostModelType.HeaderPost + PostCollection.Id),
                        PostData = PostCollection,
                        IsDefaultFeedPost = true,
                        PostDataDecoratedContent = TextDecorator.SetupStrings(PostCollection, MainContext),
                    };
        ...
        public void AddPostTextSection(bool isSharing = false)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        TypeView = PostModelType.TextSectionPostPart,
                        Id = Convert.ToInt32((int)PostModelType.TextSectionPostPart + PostCollection.Id),
                        PostData = PostCollection,
                        IsDefaultFeedPost = true 
                    };
        ...
        public void AddPostPrevBottom()
        {
            try
            {
                ...
                var item = new AdapterModelsClass
                {
                    ...
                    Id = Convert.ToInt32((int)PostModelType.PrevBottomPostPart + PostCollection.Id),
        ...
        public void AddPostFooter()
        {
            try
            {
                ...
                var item = new AdapterModelsClass
                {
                    ...
                    Id = Convert.ToInt32((int)PostModelType.BottomPostPart + PostCollection.Id),
        ...
        public void AddPostDivider(int index = -1)
        {
            ...
            try
            {
                var item = new AdapterModelsClass
                {
                    ...
                    Id = Convert.ToInt32((int)PostModelType.Divider + PostCollection?.Id),
        ...
        public void AddPostCommentAbility()
        {
            try
            {
                ...
                var item1 = new AdapterModelsClass
                {
                    ...
                    Id = Convert.ToInt32((int)PostModelType.CommentSection + PostCollection?.Id),
                    PostData = PostCollection,
                    IsDefaultFeedPost = true 
                };
                PostList.Add(item1);
                ...
                var item = new AdapterModelsClass
                {
                    ...
                    Id = Convert.ToInt32((int)PostModelType.AddCommentSection + PostCollection?.Id),
                    PostData = PostCollection,
                    IsDefaultFeedPost = true 
                };
                PostList.Add(item);
                        ...
                        if (count > 0)
                        {
                            foreach (var poll in collection.Options)
                            {
                                ...
                                var i = new AdapterModelsClass
                                {
                                    ...
                                    Id = Convert.ToInt32((int)PostModelType.PollPost + collection.Id),
                    ...
                    if (PostCollection.Options != null)
                    {
                        ...
                        if (count > 0)
                        {
                            foreach (var poll in PostCollection.Options)
                            {
                                ...
                                {
                                    TypeView = PostModelType.PollPost,
                                    Id = Convert.ToInt32((int)PostModelType.PollPost + PostCollection.Id),
            ...
            try
            {
                if (PostCollection.UserData != null)
                {
                    ...
                    var item = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostModelType.AdsPost + PostCollection.Id),
                        PostData = PostCollection,
                        PostDataDecoratedContent = TextDecorator.SetupStrings(PostCollection, MainContext),
                        IsDefaultFeedPost = true
                    };
            ...
            try
            {
                if (PostCollection.Job != null)
                {
                    ...
                    var i = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostModelType.JobPostSection1 + PostCollection.Id),
                    ...
                    var i2 = new AdapterModelsClass
                    {
                        ...
                        Id = Convert.ToInt32((int)PostModelType.JobPostSection2 + PostCollection.Id),
