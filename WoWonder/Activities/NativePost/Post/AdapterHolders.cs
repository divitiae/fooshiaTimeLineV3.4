...
namespace WoWonder.Activities.NativePost.Post
{
    ...
    { 
        ...
        {
            public View MainView { get; private set; }
            public NativePostAdapter PostAdapter;
            private readonly PostClickListener PostClickListener;
                ...
                try
                {
                    if (AdapterPosition != RecyclerView.NoPosition)
                    {
                        ...
                        if (v.Id == IconMore.Id)
                        {
                            ...
                            {
                                Methods.DisplayReportResultTrack(e);  Log.Debug("wael >> AdapterBinders", e.Message + "\n" + e.StackTrace + "\n" + e.HelpLink);
                            }
                        }
        ...
        public class InfoUserBoxViewHolder : RecyclerView.ViewHolder, View.IOnClickListener
        {
            ...
            public InfoUserBoxViewHolder(View itemView) : base(itemView)
            {
                try
                {
                    MainView = itemView;
            ...
            public void OnClick(View v)
            {
                try
                {
                    ...
                    {
                        Methods.App.OpenbrowserUrl(MainView.Context, WebsiteText.Text);
                    }
                }
                catch (Exception e)
                {
        ...
        {
            public View MainView { get; private set; }
            public NativeAdScrollView NativeAdLayout { get; private set; }
            ...
            public FbAdNativeAdapterViewHolder(Activity activity ,View itemView , NativePostAdapter postAdapter) : base(itemView)
            {
                try
                {
                    ...
                    NativeAdLayout = itemView.FindViewById<NativeAdScrollView>(Resource.Id.native_ad_container);
