...
namespace WoWonder.Activities.UsersPages.Adapters
{
    ...
    { 
        ...
        private readonly ObservableCollection<PhotoAlbumObject> ImagesList;
        private readonly LayoutInflater Inflater;
        private ImageViewTouch Image;

        public TouchImageAdapter(Activity context, ObservableCollection<PhotoAlbumObject> imagesList)
        {
            try
            {
                ActivityContext = context;
                ImagesList = new ObservableCollection<PhotoAlbumObject>(imagesList);
