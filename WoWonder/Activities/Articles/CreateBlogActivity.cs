...
namespace WoWonder.Activities.Articles
{
    ...
    public class CreateBlogActivity : BaseActivity
    {
        ...
        private async void SetWebView()
        {
            try
            {
                ...
                {                            
                    ...
                    (int apiStatus, var respond) = await RequestsAsync.Global.SetBrowser();
                    if (apiStatus == 200)
                    {           
                        HybridView.LoadDataWithBaseURL(null, respond, "text/html", "UTF-8", null);
        ...
        {
            private readonly CreateBlogActivity ViewActivity;
