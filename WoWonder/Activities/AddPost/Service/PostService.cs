...
namespace WoWonder.Activities.AddPost.Service
{
    ...
    public class PostService : IntentService
    {
        ...
        private async Task AddPost()
        {
            try
            {
                var (apiStatus, respond) = await RequestsAsync.Posts.AddNewPostAsync(DataPost.IdPost, DataPost.PagePost, DataPost.Content, DataPost.PostPrivacy, DataPost.PostFeelingType, DataPost.PostFeelingText, DataPost.PlaceText, DataPost.AttachmentList, DataPost.AnswersList, DataPost.IdColor, DataPost.AlbumName);
                if (apiStatus == 200)
                {
                                        ...
                                        case "Normal_Gallery":
                                            {
                                                ...
                                                if (DataPost.IdPost == UserDetails.UserId)
                                                {
                                                    ...
                                                    var combine1 = new FeedCombiner(postObject.PostData, myProfileActivity.PostFeedAdapter.ListDiffer, this);
                                        ...
                                        case "SocialGroup_Gallery":
                                            {
                                                ...
                                                var combine = new FeedCombiner(postObject.PostData, groupProfileActivity.PostFeedAdapter.ListDiffer, this);
                                        ...
                                        case "SocialPage_Gallery":
                                            {
                                                ...
                                                var combine = new FeedCombiner(postObject.PostData, pageProfileActivity.PostFeedAdapter.ListDiffer, this);
                                        ...
                                        case "SocialEvent_Gallery":
                                            {
                                                ...
                                                var combine = new FeedCombiner(postObject.PostData, eventViewActivity.PostFeedAdapter.ListDiffer, this);
