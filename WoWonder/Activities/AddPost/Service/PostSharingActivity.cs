...
{
    [Activity(Icon = "@mipmap/icon", Label = "Post Sharing", Theme = "@style/MyTheme", ConfigurationChanges = ConfigChanges.Locale | ConfigChanges.UiMode | ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    ...
    public class PostSharingActivity : BaseActivity, SlidingPaneLayout.IPanelSlideListener, SlidingUpPanelLayout.IPanelSlideListener, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback, MaterialDialog.IInputCallback
    {
        ...
        private void GetPrivacyPost()
        {
            try
            {
                ...
                else if (PagePost == "SocialGroup" || PagePost == "SocialGroup_More" || PagePost == "SocialGroup_Gallery")
                {
                ...
                else if (PagePost == "SocialPage" || PagePost == "SocialPage_More" || PagePost == "SocialPage_Gallery")
                {
                ...
                else if (PagePost == "SocialEvent" || PagePost == "SocialEvent_More" || PagePost == "SocialEvent_Gallery")
                {
