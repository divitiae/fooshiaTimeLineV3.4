...
{
    public class SendMoneyFragment : Android.Support.V4.App.Fragment 
    {
        ...
        private async void BtnContinueOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                (int apiStatus, var respond) = await RequestsAsync.Global.SendMoneyWalletAsync(UserId, TxtAmount.Text);
                if (apiStatus == 200)
                {
