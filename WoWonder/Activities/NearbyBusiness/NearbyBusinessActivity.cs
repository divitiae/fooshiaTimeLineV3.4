    ...
    public class NearbyBusinessActivity : BaseActivity
    {
        ...
        private async Task LoadShopsAsync(string offset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                int countList = MAdapter.NearbyBusinessList.Count;
                (int apiStatus, var respond) = await RequestsAsync.Global.GetNearbyBusinesses("10", offset, SearchText, UserDetails.NearbyBusinessDistanceCount);
